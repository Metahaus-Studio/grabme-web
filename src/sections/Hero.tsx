...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#050505] px-6 pb-24 pt-32 text-white md:pt-40">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_74%_24%,rgba(122,201,67,0.24),transparent_28%),radial-gradient(circle_at_18%_70%,rgba(122,201,67,0.1),transparent_28%)]" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        >
          ...
          <h1 className="max-w-4xl text-5xl font-black leading-[0.92] tracking-[-0.06em] md:text-6xl xl:text-7xl">
        ...
        >
          <div className="absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#7AC943]/20 blur-3xl" />

          <div className="absolute left-[58%] top-16 z-10 h-[430px] w-[230px] -translate-x-1/2 rounded-[3rem] border border-white/5 bg-white/[0.025] backdrop-blur-xl" />

          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
            className="absolute left-1/2 top-0 z-20 -translate-x-1/2 scale-[0.96]"
          >
            <AppScreen type="home" />
          </motion.div>
        </motion.div>
