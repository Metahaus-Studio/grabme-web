...
export function PhoneMockup() {
  ...
  return (
    <div className="relative mx-auto h-[640px] w-[318px] rounded-[3.2rem] border border-white/20 bg-[#0B0F0D] p-4 shadow-2xl shadow-[#53e36a]/20">
        ...
        <div className="relative h-full overflow-hidden bg-[#07100A] p-5">
          ...
          <div className="relative z-10 mt-3 flex gap-2 overflow-hidden">
            {[
              ...
              >
                <Icon size={12} className="text-[#53e36a]" />
                {label as string}
              </div>
            ))}
          </div>
          ...
          <div className="absolute bottom-5 left-4 right-4 z-10 rounded-[2rem] border border-white/10 bg-black/75 p-5 shadow-2xl backdrop-blur-xl">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="rounded-full bg-[#53e36a]/15 px-3 py-1 text-xs font-bold text-[#53e36a]">
                3 min
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center justify-between rounded-2xl bg-white/5 p-3">
              <span className="flex items-center gap-2 text-xs text-white/70">
                <ShieldCheck size={14} className="text-[#53e36a]" />
                Secure ride
              </span>
              <span className="flex items-center gap-1 text-xs">
                <CreditCard size={14} className="text-[#53e36a]" /> Wallet / Card
              </span>
            </div>
          </div>

          <MapPin className="absolute right-10 top-72 z-10 text-[#53e36a]" />
        </div>
      </div>
    </div>
  );
